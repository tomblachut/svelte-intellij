...
internal val SVELTEJS_FILE: IFileElementType = JSFileElementType.create(SvelteJSLanguage.INSTANCE)

internal class SvelteJSParserDefinition : ECMA6ParserDefinition() {
