...
class SvelteAttachCompletionProvider : CompletionProvider<CompletionParameters>() {
  override fun addCompletions(
    ...
    val newResult = if (token != null && token.elementType == JSTokenTypes.AT) {
    ...
    newResult.addElement(
      LookupElementBuilder.create("@attach")
        .withBoldness(true)
