...
public class SvelteElseIfContinuationTagImpl extends SvelteContinuationTagImpl implements SvelteElseIfContinuationTag {

  public SvelteElseIfContinuationTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SvelteVisitor visitor) {
    visitor.visitElseIfContinuationTag(this);
  }
