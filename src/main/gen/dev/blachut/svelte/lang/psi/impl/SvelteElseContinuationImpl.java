...
public class SvelteElseContinuationImpl extends ASTWrapperPsiElement implements SvelteElseContinuation {

  public SvelteElseContinuationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SvelteVisitor visitor) {
    visitor.visitElseContinuation(this);
  }
